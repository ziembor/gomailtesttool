...
- `-completion <shell>` - Generate completion script for specified shell (bash or powershell) and exit
  ...
  - Example: `./msgraphtool.exe -completion bash > completion.bash`
...
notepad $PROFILE
# Add this line:
. C:\path\to\msgraphtool-completion.ps1
...
```
PowerShell completion for msgraphtool loaded successfully!
Try typing: msgraphtool.exe -<TAB>
```
...
**Example:**
```bash
# After typing: ./msgraphtool.exe -action <TAB>
...
./msgraphtool.exe -action <TAB>
# Shows: getevents  sendmail  sendinvite  getinbox

./msgraphtool.exe -loglevel <TAB>
...
```bash
# Generated files
$ ls -lh msgraphtool-completion.*
-rw-r--r-- 1 user group 2.4K Jan  5 12:21 msgraphtool-completion.bash
-rw-r--r-- 1 user group 5.3K Jan  5 12:21 msgraphtool-completion.ps1

# Bash script validation
$ bash -n msgraphtool-completion.bash
# (No errors - syntax is valid)

# PowerShell script validation
$ pwsh -Command ". .\msgraphtool-completion.ps1"
PowerShell completion for msgraphtool loaded successfully!
Try typing: msgraphtool.exe -<TAB>
```
...
2. Replace existing `msgraphtool.exe`
...
```bash
# Bash (Linux)
./msgraphtool.exe -completion bash | sudo tee /etc/bash_completion.d/msgraphtool

# Bash (macOS)
./msgraphtool.exe -completion bash > /usr/local/etc/bash_completion.d/msgraphtool

# PowerShell (Windows)
./msgraphtool.exe -completion powershell > $PROFILE-completion.ps1
