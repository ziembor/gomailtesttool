...
func main() {
	...
	slogLogger, csvLogger, err := bootstrap.InitLoggers("imaptool", config.Action, config.VerboseMode, config.LogLevel, config.LogFormat)
	if err != nil {
